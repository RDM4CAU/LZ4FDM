...
{{0-4}}
********************************************************************************
Für die Gestaltung von Lehre bieten sie folgende **Vorteile**<!-- style="color: green" -->:
********************************************************************************
...
... die *Definition von Forschungsdaten*<!-- style="color: DarkKhaki" -->  *wiedergeben*<!-- style="color: Orchid" --> und verschiedene *Formen von Forschungsdaten*<!-- style="color: DarkKhaki" --> *benennen*<!-- style="color: Orchid" -->.

... *Komponenten eines DMP*<!-- style="color: DarkKhaki" --> *aufzählen*<!-- style="color: Orchid" -->.

… *unter Anleitung*<!-- style="color: LightSeaGreen" --> *Metadatenstandards*<!-- style="color: DarkKhaki" --> *finden*<!-- style="color: Orchid" -->.

... verschiedene *Verfahren zur Anonymisierung und Pseudonymisierung*<!-- style="color: DarkKhaki" --> von Daten *eigenständig*<!-- style="color: LightSeaGreen" --> auf eigene Daten *anwenden*<!-- style="color: Orchid" -->. 

</div>

<div style="float:right; width:30%;">

* *Inhaltkomponente*<!-- style="color: DarkKhaki" -->
* *Verhaltenskomponente*<!-- style="color: Orchid" -->
...
|:------------------------------------------ |:------------------------------------------------- |:------------------------------------------------- |
| <!-- style="background: lightcyan"--> Sachkompetenz [SK]   | <!-- style="background: lightcyan"--> Fähigkeit & Bereitschaft, Aufgaben/Problemstellungen fachlich angemessen zu bearbeiten und das Ergebnis zu beurteilen. |<!-- style="background: lightcyan"--> *Lernende können erklären, was eine Forschungsdatenpolicy ist.* |
