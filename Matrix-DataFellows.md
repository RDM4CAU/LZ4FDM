...
**The high diversity of responsibilities for Data Stewards is a particular challenge in the development of training programmes. 👉 👩‍🏫**
...
<div style="width: 100%; float: left; padding: 25px; font-size: 25px; text-align: left; background-color: #bfefff">
{{1-5}}
************
...
![](./images/lzm-data-zenodo.png "LZM-FDM provided files in Zenodo publication")<!-- style="width: 97%; height: 600px" -->
*************
...
✅ Specify performance conditions (e.g. „indipendently“, „in writing“)

✅ Add time constraints (e.g. „within 30 minutes“)

✅ Define success criteria (e.g. „min 90% answers must be correct“)
...
**✅ Feel free to use the matrix as source of inspiration and create even more learning objectives!**</div>
